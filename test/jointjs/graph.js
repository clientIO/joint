module('graph', {
    ...
    setupTestTreeGraph: function(graph) {
...
test('storing reference on models', function(assert) {
...
test('graph.getCommonAncestor()', function(assert) {
...
test('graph.getConnectedLinks()', function(assert) {
...
test('graph.getSources(), graph.getSinks(), isSource(), isSink()', function(assert) {
...
test('graph.getSuccessors(), graph.isSuccessor()', function(assert) {
...
test('graph.getPredecessors(), graph.isPredecessor()', function(assert) {
...
test('graph.bfs(), graph.dfs()', function(assert) {
...
test('graph.cloneCells()', function(assert) {
...
test('graph.cloneSubgraph()', function(assert) {
...
test('graph.getSubgraph()', function(assert) {
...
test('graph.getBBox()', function() {
    ...
    equal(this.graph.getBBox([]), undefined, 'graph.getBBox([]) with empty array returns undefined');

    var l = new joint.dia.Link();
    this.graph.addCell(l);
    equal(this.graph.getBBox([l]), undefined, 'graph.getBBox() with links only returns undefined');
});
...
test('graph.getNeighbors(), graph.isNeighbor()', function(assert) {
...
test('findModelsInArea(rect[, opt])', function(assert) {
    ...
    assert.equal(modelsInArea.length, 0, 'rect is object');
});

test('translate(dx, dy, opt)', function(assert) {
