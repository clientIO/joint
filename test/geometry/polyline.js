    ...
    QUnit.module('prototype', function() {
        ...
        QUnit.module('bbox()', function() {
            ...
            QUnit.test('sanity', function(assert) {
                ...
                assert.ok(g.Polyline([g.Point(100, 100)]).bbox() instanceof g.Rect);
                assert.ok(g.Polyline([g.Point(100, 100), g.Point(200, 100)]).bbox() instanceof g.Rect);
            });

            QUnit.test('should return the polyline\'s bounding box', function(assert) {

                assert.equal(g.Polyline([g.Point(100, 100)]).bbox().toString(), "100@100 100@100");
                assert.equal(g.Polyline([g.Point(100, 100), g.Point(200, 100)]).bbox().toString(), "100@100 200@100");
            });
        });
