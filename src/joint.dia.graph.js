...
joint.dia.Graph = Backbone.Model.extend({
    ...
    _restructureOnReset: function(cells) {
        ...
        cells.forEach(this._restructureOnAdd.bind(this));
    },
    ...
    clear: function(opt) {
        ...
        opt = Object.assign({}, opt, { clear: true });
    ...
    addCell: function(cell, opt) {
        ...
        } else if (typeof cell.z === 'undefined') {
    ...
    getConnectedLinks: function(model, opt) {
        ...
        if (typeof inbound === 'undefined' && typeof outbound === 'undefined') {
        ...
        if (outbound) {
            joint.util.each(this.getOutboundEdges(model.id), (exists, edge) => {
                if (!edges[edge]) {
        ...
        if (inbound) {
            joint.util.each(this.getInboundEdges(model.id), (exists, edge) => {
        ...
        if (opt.deep) {
            ...
            embeddedCells.forEach((cell) => {
                ...
                if (outbound) {
                    joint.util.each(this.getOutboundEdges(cell.id), (exists, edge) => {
                ...
                if (inbound) {
                    joint.util.each(this.getInboundEdges(cell.id), (exists, edge) => {
                        if (!edges[edge] && !embeddedEdges[edge]) {
                            links.push(this.getCell(edge));
                            edges[edge] = true;
                        }
    ...
    getSuccessors: function(element, opt) {
        ...
        }, Object.assign({}, opt, { outbound: true }));
        return res;
    },
    ...
    getPredecessors: function(element, opt) {
        ...
        }, Object.assign({}, opt, { inbound: true }));
        return res;
    },
    ...
    dfs: function(element, iteratee, opt, _visited, _distance) {
        ...
        this.getNeighbors(element, opt).forEach((neighbor) => {
    ...
    findModelsUnderElement: function(element, opt) {
        ...
        return joint.util.reject(elements, function(el) {
    ...
    translate: function(dx, dy, opt) {
        ...
        var cells = joint.util.reject(this.getCells(), function(cell) {
    ...
    startBatch: function(name, data) {
        ...
        return this.trigger('batch:start', Object.assign({}, data, { batchName: name }));
    },
    ...
    stopBatch: function(name, data) {
        ...
        return this.trigger('batch:stop', Object.assign({}, data, { batchName: name }));
    },
    ...
    hasActiveBatch: function(name) {
        if (name) {
            ...
            return Object.values(this._batches).some(function(batches) { return batches > 0; });
        }
    }
});
