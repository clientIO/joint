...
joint.dia.Link = joint.dia.Cell.extend({
    ...
    markup: joint.templates['markup'],

    labelMarkup: joint.templates['labelMarkup'],

    toolMarkup: joint.templates['toolMarkup'],
    ...
    vertexMarkup: joint.templates['vertexMarkup'],

    arrowheadMarkup: joint.templates['arrowheadMarkup'],
...
joint.dia.LinkView = joint.dia.CellView.extend({
    ...
    render: function() {
        ...
        var linkMarkup = this.model.get('markup') || this.model.markup;
        var children = V(linkMarkup());
    ...
    renderLabels: function() {
        ...
        var labelTemplate = this.model.get('labelMarkup') || this.model.labelMarkup;
    ...
    renderTools: function() {
        ...
        var toolTemplate = this.model.get('toolMarkup') || this.model.toolMarkup;
    ...
    renderVertexMarkers: function() {
        ...
        var markupTemplate = this.model.get('vertexMarkup') || this.model.vertexMarkup;
    ...
    renderArrowheadMarkers: function() {
        ...
        // if default styling (elements) are not desired. This makes it possible to use any
        // SVG elements for .marker-vertex and .marker-vertex-remove tools.
        var markupTemplate = this.model.get('arrowheadMarkup') || this.model.arrowheadMarkup;
