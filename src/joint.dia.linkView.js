(function(joint, util) {
    ...
    joint.dia.LinkView = joint.dia.CellView.extend({
        ...
        renderStringMarkup: function(markup) {
            ...
            for (var i = 0, n = children.length; i < n; i++) {
                ...
                if (className) {
                    ...
                    className = util.removeClassNamePrefix(className);
        ...
        _getLabelJSONMarkup: function(labelMarkup) {
            ...
            return util.parseDOMJSON(labelMarkup); // fragment and selectors
        },
        ...
        _mergeLabelAttrs: function(hasCustomMarkup, labelAttrs, defaultLabelAttrs, builtinDefaultLabelAttrs) {
            ...
            if (labelAttrs === undefined) {
                ...
                return util.merge({}, builtinDefaultLabelAttrs, defaultLabelAttrs);
            }

            if (hasCustomMarkup) return util.merge({}, defaultLabelAttrs, labelAttrs);
            return util.merge({}, builtinDefaultLabelAttrs, defaultLabelAttrs, labelAttrs);
        },
        ...
        renderTools: function() {
            ...
            var toolTemplate = util.template(this.model.get('toolMarkup') || this.model.toolMarkup);
            ...
            if (this.options.doubleLinkTools) {
                ...
                if (this.model.get('doubleToolMarkup') || this.model.doubleToolMarkup) {
                    toolTemplate = util.template(this.model.get('doubleToolMarkup') || this.model.doubleToolMarkup);
        ...
        renderVertexMarkers: function() {
            ...
            var markupTemplate = util.template(this.model.get('vertexMarkup') || this.model.vertexMarkup);

            this.model.vertices().forEach(function(vertex, idx) {

                $markerVertices.append(V(markupTemplate(util.assign({ idx: idx }, vertex))).node);
            });
        ...
        renderArrowheadMarkers: function() {
            ...
            // if default styling (elements) are not desired. This makes it possible to use any
            // SVG elements for .marker-vertex and .marker-vertex-remove tools.
            var markupTemplate = util.template(this.model.get('arrowheadMarkup') || this.model.arrowheadMarkup);
        ...
        updateLabelPositions: function() {
            ...
            var defaultPosition = util.merge({}, builtinDefaultLabelPosition, defaultLabelPosition);
            ...
            for (var idx = 0, n = labels.length; idx < n; idx++) {
                ...
                var position = util.merge({}, defaultPosition, labelPosition);
        ...
        onEndModelChange: function(endType, endModel, opt) {
            ...
            if (endModel) {
                ...
                if (opt.handleBy === this.cid && opt.translateBy &&
                    ...
                    !util.isEmpty(model.get('vertices'))) {
                ...
                if (!this.updatePostponed && oppositeEndId) {
                    ...
                    if (end.id === oppositeEnd.id) {
                        ...
                        // the target model).
                        if (!opt.translateBy || util.isEmpty(model.get('vertices')) || !model.isEmbeddedIn(opt.translateBy)) {
        ...
        _translateAndAutoOrientArrows: function(sourceArrow, targetArrow) {
            ...
            var route = util.toArray(this.route);
            if (sourceArrow) {
        ...
        _mergeLabelPositionArgs: function(labelPositionArgs, defaultLabelPositionArgs) {
            ...
            return util.merge({}, defaultLabelPositionArgs, labelPositionArgs);
        },
        ...
        findRoute: function(vertices) {
            ...
            var routerFn = util.isFunction(router) ? router : namespace[router.name];
            if (!util.isFunction(routerFn)) {
        ...
        findPath: function(route, sourcePoint, targetPoint) {
            ...
            var connectorFn = util.isFunction(connector) ? connector : namespace[connector.name];
            if (!util.isFunction(connectorFn)) {
                throw new Error('dia.LinkView: unknown connector: "' + connector.name + '".');
            }

            var args = util.clone(connector.args || {});
        ...
        pointermove: function(evt, x, y) {
            ...
            // Backwards compatibility
            if (dragData) util.assign(dragData, this.eventData(evt));
        ...
        startArrowheadMove: function(end, opt) {
            ...
            var data = {
                ...
                initialEnd: util.clone(this.model.get(end)),
