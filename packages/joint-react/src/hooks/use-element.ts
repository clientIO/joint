 ...
 * );
 *
 * @param {Function} selector The selector function to pick part of the element. @default defaultElementSelector
 * @param {Function=} isEqual The function used to check equality. @default util.isEqual
