    ...
    <div className="flex flex-col relative w-full h-full">
      <Paper
        ...
        portalSelector={(cellView, defaultSelector) => {
          // dia.Cell already exposes isElement() / isLink() so we don't have to
          // second-guess the type string — any Element subclass reports true.
          return cellView.model.isElement() ? defaultSelector : 'root';
        }}
        style={PAPER_STYLE}
        drawGrid={false}
      >
