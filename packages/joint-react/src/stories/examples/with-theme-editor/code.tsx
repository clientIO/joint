...
const LIGHT_THEME: CSSVars = {
  ...
  '--jj-paper-border-color': pv('color-border'),
...
const CSS_DEFAULTS: CSSVars = {
  ...
  '--jj-paper-color': p('light-300'),
  '--jj-paper-border-color':     pv('color-border'),
  '--jj-paper-border-style':     'solid',
  '--jj-paper-border-width':     '1px',
  '--jj-paper-box-shadow':       '0 3px 11px rgba(0,0,0,0.11), 0 1px 4px rgba(0,0,0,0.05)',
  '--jj-paper-grid-color':       p('light-700'),
  '--jj-paper-grid-size':        '10',
  '--jj-paper-grid-thickness':   '2',
  '--jj-paper-highlight-color':  pv('color-primary'),
  '--jj-link-color':             pv('color-link'),
  '--jj-link-width':             '1',
  '--jj-link-dash':              'none',
  '--jj-link-line-cap':          'butt',
  '--jj-link-hover-color':       pv('color-primary'),
  '--jj-link-hover-width':       '1.5',
  '--jj-link-selected-color':    pv('color-primary'),
  '--jj-link-selected-width':    '1.5',
  ...
  '--jj-port-connecting-border-width': '1.5px',
...
const BORDER_STYLE_OPTIONS: readonly CSVariableOption[] = [
...
const SECTIONS: readonly SectionDefinition[] = [
  ...
  },
  {
    ...
    vars: [
      ...
      { name: '--jj-paper-border-color',    type: 'color' },
      { name: '--jj-paper-border-style',    type: 'cssvar', options: BORDER_STYLE_OPTIONS },
      { name: '--jj-paper-border-width',    type: 'dimension' },
      { name: '--jj-paper-grid-color',      type: 'color' },
      { name: '--jj-paper-grid-size',       type: 'number' },
      { name: '--jj-paper-grid-thickness',  type: 'number' },
      { name: '--jj-paper-highlight-color', type: 'color' },
      { name: '--jj-paper-box-shadow',      type: 'dimension' },
    ],
  },
  {
    title: 'Links',
    vars: [
      ...
      { name: '--jj-link-hover-color',      type: 'color' },
      { name: '--jj-link-hover-width',      type: 'number' },
      { name: '--jj-link-selected-color',   type: 'color' },
      { name: '--jj-link-selected-width',   type: 'number' },
  ...
  },
  {
    ...
    vars: [
      ...
      { name: '--jj-port-connecting-color',         type: 'color' },
      { name: '--jj-port-connecting-border-color',  type: 'color' },
      { name: '--jj-port-connecting-border-width',  type: 'dimension' },
