...
export type RenderElement<ElementItem = FlatElementData> = (
  element: ElementItem
) => ReactNode;

export type RenderLink<LinkItem = FlatLinkData> = (link: LinkItem) => ReactNode;
 ...
 */
export interface PaperProps<ElementItem = FlatElementData>
