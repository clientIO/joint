...
/**
 * Converts a simplified ElementPort to a full JointJS port definition.
 ...
 */
function convertPort(id: string, rawPort: ElementPort, portStyle?: Partial<ElementPort>): dia.Element.Port {
