...
describe('create-store-data', () => {
  it('should handle proper data insertion', () => {
    ...
    expect(storeData.elements.size).toBe(0);
    storeData.updateStore(graph);
    expect(storeData.elements.size).toBe(1);
  });
  it('should handle proper data update', () => {
    ...
    storeData.updateStore(graph);
    expect(storeData.elements.size).toBe(1);
    expect(storeData.elements.get('element1')?.x).toBe(10);
    ...
    expect(storeData.elements.size).toBe(1);
    storeData.updateStore(graph);
    expect(storeData.elements.get('element1')?.x).toBe(30);
  });
