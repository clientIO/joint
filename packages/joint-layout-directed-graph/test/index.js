...
QUnit.module("DirectedGraph", function (hooks) {
    ...
    QUnit.test(
        "should correctly convert a graphlib graph into JointJS graph",
        function (assert) {
            ...
            const targetGraph = new joint.dia.Graph(
                {},
    ...
    QUnit.module("layout(graphOrCells[, opt])", function (hooks) {
        ...
        QUnit.test("should correctly layout the graph", function (assert) {
            ...
            var links = [
                ...
                new joint.shapes.standard.Link({
                    source: { id: elements[1].id },
                    target: { id: elements[3].id },
                }),
            ];
        ...
        QUnit.test(
            "an array of some of the cells instead of the full graph",
            function (assert) {
                var elements = [
                    new joint.shapes.standard.Rectangle({
                        position: { x: 0, y: 0 },
                ...
                DirectedGraph.layout([elements[0], elements[1], links[0]]);
        ...
        QUnit.test(
            "an array of embedded cells without the parent",
            function (assert) {
                var elements = [
                    new joint.shapes.standard.Rectangle({
                        position: { x: 0, y: 0 },
                ...
                var links = [
                    new joint.shapes.standard.Link({
                        source: { id: elements[1].id },
                        target: { id: elements[2].id },
                    }),
                    new joint.shapes.standard.Link({
                        source: { id: elements[2].id },
                        target: { id: elements[3].id },
                    }),
                ];
        ...
        QUnit.test(
            "should return a rectangle representing the graph bounding box",
            function (assert) {
                var bbox;
        ...
        QUnit.test(
            "resizeClusters: false, clusterPadding: number - should not resize clusters",
            function (assert) {
                const deepestSize = {
                    width: 500,
                    height: 500,
        ...
        QUnit.test(
            "resizeClusters: true, clusterPadding: number - should resize clusters according to our algorithm",
            function (assert) {
                const deepestSize = {
                    width: 500,
                    height: 500,
        ...
        QUnit.test(
            "resizeClusters: true, clusterPadding: number - should not resize clusters if `glGraph` does not hold reference to their children",
            function (assert) {
                const containerSize = {
                    width: 500,
                    height: 500,
                ...
                const container1 = new joint.shapes.standard.Rectangle({
                    size: containerSize,
                });
                const container2 = new joint.shapes.standard.Rectangle({
                    size: containerSize,
                });
        ...
        QUnit.test(
            "resizeClusters: false, clusterPadding: 'default' - should not resize clusters",
            function (assert) {
                const deepestSize = {
                    width: 500,
                    height: 500,
        ...
        QUnit.test(
            "resizeClusters: true, clusterPadding: 'default' - should resize nested clusters according to default dagre algorithm",
            function (assert) {
                const deepestSize = {
                    width: 500,
                    height: 500,
        ...
        QUnit.test(
            "resizeClusters: true, clusterPadding: 'default' - should resize clusters with connected non-embedded children according to default dagre algorithm",
            function (assert) {
                const elements = [
                    new joint.shapes.standard.Rectangle({
                        position: { x: 0, y: 0 },
                ...
                for (let i = 0; i < elements.length; i++) {
                    assert.deepEqual(
                        elements[i].getBBox(),
                        new joint.g.Rect(expectedBBoxes[i]),
                    );
                }
            },
        );
        ...
        QUnit.test(
            "resizeClusters: true, clusterPadding: 'default' - should not resize clusters if `glGraph` does not hold reference to their children",
            function (assert) {
                const containerSize = {
                    width: 500,
                    height: 500,
        ...
        QUnit.test(
            "customOrder: function - should allow to specify a custom order of the elements",
            function (assert) {
                assert.expect(4);
