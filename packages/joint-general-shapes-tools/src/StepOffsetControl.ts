...
export class StepOffsetControl extends elementTools.Control<StepOffsetControlOptions> {
    ...
    get element(): Step {
        return this.relatedView.model as Step;
    }
    ...
    protected setPosition(view: dia.ElementView, coordinates: dia.Point) {
        ...
        const offset = Math.max(0, Math.min(coordinates.x, width));
