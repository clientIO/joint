QUnit.module('GraphLayerCollection', function(hooks) {
    ...
    QUnit.test('add invalid GraphLayer type', (assert) => {
        ...
        }, /dia.Graph: Could not find layer constructor for type: 'InvalidType'. Make sure to add the constructor to 'layerNamespace'./, 'throws error when adding invalid GraphLayer type');
    });
