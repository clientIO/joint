QUnit.module('embedding', function(hooks) {
    ...
    QUnit.test('findParentBy option', function(assert) {
        ...
        var data;
        var r1 = new joint.shapes.standard.Rectangle({ position: { x: 100, y: 100 }, size: { width: 100, height: 100 }});
        var r2 = new joint.shapes.standard.Rectangle({ position: { x: 50, y: 50 }, size: { width: 100, height: 100 }});
    ...
    QUnit.test('highlighting & unhighlighting', function(assert) {
        ...
        var r1 = new joint.shapes.standard.Rectangle({ position: { x: 0, y: 0 }, size: { width: 1000, height: 1000 }});
        var r2 = new joint.shapes.standard.Rectangle({ position: { x: 50, y: 50 }, size: { width: 100, height: 100 }});
    ...
    QUnit.test('frontParentOnly option', function(assert) {
        ...
        var data;
        var r1 = new joint.shapes.standard.Rectangle({ position: { x: 0, y: 0 }, size: { width: 200, height: 200 }});
        var r2 = new joint.shapes.standard.Rectangle({ position: { x: 50, y: 50 }, size: { width: 100, height: 100 }});
        var r3 = new joint.shapes.standard.Rectangle({ position: { x: 50, y: 50 }, size: { width: 100, height: 100 }});
