...
export namespace dia {
  ...
  class GraphLayerCollection<
    L extends GraphLayer = GraphLayer,
  > extends mvc.Collection<L> {
    cellNamespace: any;
    layerNamespace: any;
    graph: Graph;

    insert(
      layer: Graph.LayerInit,
      beforeId: GraphLayer.ID | null,
      opt?: ObjectHash,
    ): void;
  ...
  export namespace Graph {
    ...
    interface FindUnderElementOptions
      extends FindInAreaOptions,
        FindAtPointOptions {
  ...
  class Graph<
    A extends ObjectHash = Graph.Attributes,
    S = dia.ModelSetOptions,
  > extends mvc.Model<A, S> {
    layerCollection: GraphLayerCollection;
    ...
    removeCells(
      cells: Array<Graph.CellRef>,
      opt?: Graph.RemoveCellOptions,
    ): this;
    ...
    findElementsUnderElement(
      element: Element,
      opt?: Graph.FindUnderElementOptions,
    ): Element[];
    ...
    protected _getFindUnderElementGeometry(
      element: Element,
      searchBy: Graph.SearchByKey,
    ): g.Point | g.Rect;

    protected _validateCellsUnderElement<T extends Cell[]>(
      cells: T,
      element: Element,
    ): T;
    ...
    protected _filterCellsUnderElement(
      cells: Cell[],
      element: Element,
      opt: Graph.FindUnderElementOptions,
    ): Cell[];
    ...
    protected _replaceCell(
      currentCell: Cell,
      newCellInit: Graph.CellInit,
      opt?: Graph.Options,
    ): void;

    protected _resetLayers(
      layers: Array<Graph.LayerInit>,
      defaultLayerId: GraphLayer.ID | null,
      opt?: Graph.Options,
    ): this;
  ...
  export namespace Cell {
    ...
    type JSON<
      K extends Selectors = Selectors,
      T extends GenericAttributes<K> = GenericAttributes<K>,
    > = T & {
  ...
  class Cell<
    A extends ObjectHash = Cell.Attributes,
    S extends mvc.ModelSetOptions = dia.ModelSetOptions,
  > extends mvc.Model<A, S> {
    ...
    static getAttributeDefinition(
      attrName: string,
    ): Cell.PresentationAttributeDefinition<CellView> | null;
  ...
  export namespace Element {
    ...
    interface ConstructorOptions extends Cell.ConstructorOptions {
      ...
      portLabelLayoutNamespace?: {
        [key: string]: layout.PortLabel.LayoutFunction;
      };
    }
  ...
  class Element<
    A extends ObjectHash = Element.Attributes,
    S extends mvc.ModelSetOptions = dia.ModelSetOptions,
  > extends Cell<A, S> {
    ...
    insertPort(
      before: number | string | Element.Port,
      port: Element.Port,
      opt?: S,
    ): this;
    ...
    getPortsPositions(groupName: string): {
      [id: string]: Element.PortPosition;
    };
    ...
    static define(
      ...
      protoProps?: any,
      staticProps?: any,
    ): Cell.Constructor<Element>;

    static attributes: {
      [
        attributeName: string
      ]: Cell.PresentationAttributeDefinition<ElementView>;
    };
  }
  ...
  class Link<
    A extends ObjectHash = Link.Attributes,
    S extends mvc.ModelSetOptions = dia.ModelSetOptions,
  > extends Cell<A, S> {
    toolMarkup: string;
    ...
    router(
      name: routers.RouterType,
      args?: routers.RouterArguments,
      opt?: S,
    ): this;
    ...
    connector(
      name: connectors.ConnectorType,
      args?: connectors.ConnectorArguments,
      opt?: S,
    ): this;
    ...
    static define(
      ...
      protoProps?: any,
      staticProps?: any,
    ): Cell.Constructor<Link>;

    static attributes: {
      [attributeName: string]: Cell.PresentationAttributeDefinition<LinkView>;
    };
  }
  ...
  export namespace CellView {
    ...
    interface InteractivityOptions
      extends ElementView.InteractivityOptions,
        LinkView.InteractivityOptions {}
  ...
  abstract class CellViewGeneric<T extends Cell> extends mvc.View<
    T,
    SVGElement
  > {
    ...
    isIntersecting(
      geometryShape: g.Shape,
      geometryData?: g.SegmentSubdivisionsOpt | null,
    ): boolean;
    ...
    static addPresentationAttributes(
      attributes: CellView.PresentationAttributes,
    ): CellView.PresentationAttributes;

    static evalAttribute(
      attrName: string,
      attrValue: any,
      refBBox: dia.BBox,
    ): any;
  ...
  class ElementView<E extends Element = Element> extends CellViewGeneric<E> {
    update(
      element?: DOMElement,
      renderingOnlyAttrs?: { [key: string]: any },
    ): void;
  ...
  export namespace LinkView {
    ...
    interface Options<L extends Link = Link>
      extends mvc.ViewOptions<L, SVGElement> {
  ...
  class LinkView<L extends Link = Link> extends CellViewGeneric<L> {
    ...
    protected onLabelsChange(
      link: Link,
      labels: Link.Label[],
      opt: { [key: string]: any },
    ): void;

    protected onToolsChange(
      link: Link,
      toolsMarkup: string,
      opt: { [key: string]: any },
    ): void;

    protected onVerticesChange(
      link: Link,
      vertices: Point[],
      opt: { [key: string]: any },
    ): void;
  ...
  export namespace Paper {
    ...
    type UpdateStats = RenderStats &
      Partial<RenderBatchStats> & {
        batches?: number;
      };

    type ViewportCallback = (
      view: mvc.View<any, any>,
      isMounted: boolean,
      paper: Paper,
    ) => boolean;
    type CellVisibilityCallback = (
      cell: Cell,
      isMounted: boolean,
      paper: Paper,
    ) => boolean;
    ...
    interface UpdateViewsBatchOptions
      extends UpdateViewOptions,
        BatchSizeOptions,
        CellVisibilityOptions {}

    interface UpdateViewsOptions
      extends UpdateViewsBatchOptions,
        RenderCallbackOptions {}

    interface UpdateViewsAsyncOptions
      extends UpdateViewsBatchOptions,
        ScheduleCellsVisibilityUpdateOptions,
        RenderCallbackOptions {
      progress?: ProgressCallback;
    }

    interface ScheduleCellsVisibilityUpdateOptions
      extends CellVisibilityOptions,
        MountOptions,
        UnmountOptions {}
    ...
    type RestrictTranslateCallback = (
      ...
      x0: number,
      y0: number,
    ) => BBox | boolean | PointConstraintCallback;
    type FindParentByType = "bbox" | "pointer" | PositionName;
    type FindParentByCallback = (
      this: dia.Graph,
      elementView: ElementView,
      evt: dia.Event,
      x: number,
    ...
    type MeasureNodeCallback = (
      node: SVGGraphicsElement,
      cellView: dia.CellView,
    ) => g.Rect;

    interface Options
      extends mvc.ViewOptions<Graph>,
        CellVisibilityOptions,
        BeforeRenderOptions,
        AfterRenderOptions {
      // appearance
      ...
      highlighting?:
        | boolean
        | Record<
            string | dia.CellView.Highlighting,
            highlighters.HighlighterJSON | boolean
          >;
      interactive?:
        | ((
            cellView: CellView,
      ...
      // views
      elementView?:
        | typeof ElementView<any>
        | ((element: Element) => typeof ElementView<any> | null | undefined);
      linkView?:
        | typeof LinkView<any>
        | ((link: Link) => typeof LinkView<any> | null | undefined);
    ...
    interface EventMap {
      ...
      "link:disconnect": (
        linkView: dia.LinkView,
        evt: dia.Event,
        prevCellView: dia.CellView,
        prevCellViewMagnet: SVGElement,
        arrowhead: dia.LinkEnd,
      ) => void;
      "link:snap:connect": (
        linkView: dia.LinkView,
    ...
    interface FindAtPointOptions
      extends Graph.FindAtPointOptions,
        BufferOptions {}

    interface FindInAreaOptions
      extends Graph.FindInAreaOptions,
        BufferOptions {}
  ...
  class Paper extends mvc.View<Graph> {
    ...
    getRestrictedArea(
      ...
      x: number,
      y: number,
    ): g.Rect | null | Paper.PointConstraintCallback;
    ...
    setDimensions(
      width: Paper.Dimension,
      height: Paper.Dimension,
      data?: any,
    ): void;
    ...
    setGrid(
      opt?: null | boolean | string | Paper.GridOptions | Paper.GridOptions[],
    ): this;
    ...
    addLayerView(
      layerView: LayerView,
      options?: Paper.InsertLayerViewOptions,
    ): void;

    moveLayerView(
      layerRef: Paper.LayerRef,
      options?: Paper.InsertLayerViewOptions,
    ): void;

    removeLayerView(layerRef: Paper.LayerRef): void;

    protected insertLayerView(
      layerView: LayerView,
      before?: Paper.LayerRef,
    ): void;

    protected requestLayerViewRemoval(layerRef: Paper.LayerRef): void;

    protected createLayerView(
      options: Omit<LayerView.Options, "paper">,
    ): LayerView;
    ...
    requireView<T extends ElementView | LinkView>(
      cellOrId: Graph.CellRef,
      opt?: Paper.UpdateViewOptions & Paper.RenderCallbackOptions,
    ): T;

    updateViews(
      opt?: Paper.UpdateViewsOptions,
    ): Paper.RenderStats & { batches: number };
    ...
    updateCellVisibility(
      ...
      opt?: Paper.CellVisibilityOptions &
        Paper.UpdateViewOptions &
        Paper.RenderCallbackOptions,
    ): void;

    updateCellsVisibility(
      opt?: Paper.ScheduleCellsVisibilityUpdateOptions &
        Paper.UpdateViewsOptions,
    ): void;

    // events

    on<T extends keyof Paper.EventMap = keyof Paper.EventMap>(
      eventName: T,
    ...
    on<T extends keyof Paper.EventMap = keyof Paper.EventMap>(
      events: { [eventName in T]: Paper.EventMap[eventName] },
      context?: any,
    ): this;
    ...
    protected scheduleCellsVisibilityUpdate(
      opt?: Paper.ScheduleCellsVisibilityUpdateOptions,
    ): Paper.UpdateVisibilityStats;
    ...
    protected updateViewsBatch(
      opt?: Paper.UpdateViewsBatchOptions,
    ): Paper.RenderBatchStats;

    protected checkMountedViews(
      viewport: Paper.ViewportCallback,
      opt?: Paper.UnmountOptions,
    ): number;

    protected checkUnmountedViews(
      viewport: Paper.ViewportCallback,
      opt?: Paper.MountOptions,
    ): number;
    ...
    protected onCellAdded(
      cell: Cell,
      collection: mvc.Collection<Cell>,
    ...
    protected onCellChanged(
      cell: mvc.Collection<Cell>,
      opt: dia.Graph.Options,
    ): void;

    protected onGraphLayerAdd(
      layer: GraphLayer,
      collection: mvc.Collection<GraphLayer>,
      opt: dia.Graph.Options,
    ): void;

    protected onGraphLayerRemove(
      layer: GraphLayer,
      collection: mvc.Collection<GraphLayer>,
      opt: dia.Graph.Options,
    ): void;

    protected onGraphLayerCollectionReset(
      layer: mvc.Collection<GraphLayer>,
      opt: dia.Graph.Options,
    ): void;

    protected onGraphLayerCollectionSort(layer: GraphLayer[]): void;

    protected onGraphReset(
      cells: mvc.Collection<Cell>,
      opt: dia.Graph.Options,
    ): void;
  ...
  namespace LayerView {
    interface Options<T extends mvc.Model | undefined = undefined>
      extends mvc.ViewOptions<T, SVGElement> {
      id: string;
      paper: Paper;
      type?: string;
    }
  ...
  class LayerView<T extends mvc.Model | undefined = undefined> extends mvc.View<
    T,
    SVGElement
  > {
  ...
  class GraphLayer<
    C extends CellCollection = CellCollection,
    A extends GraphLayer.Attributes = GraphLayer.Attributes,
    S extends mvc.ModelSetOptions = dia.ModelSetOptions,
  > extends mvc.Model<A, S> {
    declare id: string;
    ...
    constructor(
      attributes?: DeepPartial<A>,
      options?: mvc.ModelConstructorOptions<GraphLayer>,
    );
  ...
  class GraphLayerView<T extends GraphLayer = GraphLayer> extends LayerView<T> {
    ...
    protected onCellCollectionSort(
  ...
  namespace ToolView {
    type VisibilityCallback<V = dia.CellView> = (
      this: ToolView,
      view: V,
      tool: ToolView,
    ) => boolean;

    interface Options<V = dia.CellView>
      extends mvc.ViewOptions<undefined, SVGElement> {
      focusOpacity?: number;
  ...
  class HighlighterView<
    Options extends mvc.ViewOptions<
      undefined,
      SVGElement
    > = HighlighterView.Options,
  > extends mvc.View<undefined, SVGElement> {
    ...
    UPDATE_ATTRIBUTES:
      | string[]
      | ((this: HighlighterView<Options>) => string[]);
    ...
    protected findNode(
      cellView: dia.CellView,
      nodeSelector: HighlighterView.NodeSelector,
    ): SVGElement | null;
    ...
    static remove(cellView: dia.CellView, id?: string): void;

    static removeAll(paper: dia.Paper, id?: string): void;
...
export namespace highlighters {
  ...
  type GenericHighlighterArguments<K extends HighlighterType> =
    HighlighterArgumentsMap[K];
  ...
  class list<
    Item = any,
    Options extends mvc.ViewOptions<undefined, SVGElement> = list.Options,
  > extends dia.HighlighterView<Options> {
    options: Options;

    protected createListItem(
      item: Item,
      itemSize: dia.Size,
      itemEl: SVGElement | null,
    ): SVGElement;
...
export namespace shapes {
  ...
  namespace standard {
    ...
    type RectangleAttributes =
      dia.Element.GenericAttributes<RectangleSelectors>;
    ...
    type BorderedImageAttributes =
      dia.Element.GenericAttributes<BorderedImageSelectors>;
    ...
    type EmbeddedImageAttributes =
      dia.Element.GenericAttributes<EmbeddedImageSelectors>;
    ...
    type InscribedImageAttributes =
      dia.Element.GenericAttributes<InscribedImageSelectors>;
    ...
    type HeaderedRectangleAttributes =
      dia.Element.GenericAttributes<HeaderedRectangleSelectors>;
    ...
    class Cylinder<
      S extends mvc.ModelSetOptions = dia.ModelSetOptions,
    > extends dia.Element<CylinderAttributes, S> {
      topRy(): string | number;
    ...
    type TextBlockAttributes =
      dia.Element.GenericAttributes<TextBlockSelectors>;
...
export namespace util {
  ...
  export function evalCalcExpression(
    expression: string,
    rect: g.PlainRect,
  ): string;
  ...
  export function parseCssNumeric(
    val: any,
    restrictUnits: string | string[],
  ...
  export function imageToDataUri(
    url: string,
    callback: (err: Error | null, dataUri: string) => void,
  ): void;
  ...
  export namespace filter {
    ...
    type FilterFunction<K extends keyof FilterArgumentsMap> = (
  ...
  type SourceObjectsOptionalFinalCustomizer = Array<
    object | CustomizerFunction
  ...
  export function deepSupplement(
    destinationObject: object,
    ...sourceObjects: object[]
  ): object;
  ...
  export function invoke(
    ...
    methodPath: PropertyPath,
    args?: any[],
  ): any[];
  export function invoke<ArgsT>(
    collection: Collection,
    functionToInvokeForAll: IterateeFunction<ArgsT>,
    ...args: ArgsT[]
  ): any[];

  export function invokeProperty(
    object: object,
  ...
  export function groupBy(
    collection: Collection,
    iteratee?: IterateeFunction<any>,
  ): object;

  export function sortBy<T>(
    collection: object,
    iteratee?: IterateeFunction<any>[] | IterateeFunction<any>,
  ): any[];
  export function sortBy<T>(
    collection: T[],
    iteratee?: IterateeFunction<T>[] | IterateeFunction<T>,
  ): any[];
  ...
  export function omit(
    object: object,
    ...propertyPathsToOmit: PropertyPath[]
  ): object;

  export function pick(
    object: object,
    ...propertyPathsToPick: PropertyPath[]
  ): object;
  ...
  export function forIn<T>(
    object: T,
    iteratee?: (value: any, key: string, iterable: object) => void | boolean,
  ): void;
...
export namespace mvc {
    ...
    implements Events
  {
    ...
    find(
      iterator: ListIterator<TModel, boolean>,
      context?: any,
    ): TModel | undefined;
    ...
    reduce<TResult>(
      iterator: MemoIterator<TModel, TResult>,
      memo?: TResult,
    ): TResult;
  ...
  interface ViewBaseOptions<
    TModel extends Model | undefined = Model,
    TElement extends DOMElement = HTMLElement,
  > {
    ...
    implements Events
  {
    ...
    delegate(
      eventName: string,
      selector: string,
      listener: ViewBaseEventListener,
    ): this;
  ...
  interface ViewOptions<
    T extends mvc.Model | undefined,
    E extends DOMElement = HTMLElement,
  > extends mvc.ViewBaseOptions<T, E> {
    theme?: string;
    [key: string]: any;
  }
  ...
  type ModifiedCallback<
    ...
    EventCallback extends Callback,
  > = (...args: [...CallbackArgs, ...Parameters<EventCallback>]) => any;

  type EventHashMap<
    CallbackArgs extends any[],
    T extends Record<keyof T, Callback>,
  > = {
  ...
  class Listener<Args extends any[]> {
    ...
    listenTo<CB extends Callback>(
      object: any,
      evt: string,
      callback: ModifiedCallback<Args, CB>,
      context?: any,
    ): void;
    listenTo<
      EventCBMap extends Record<keyof EventCBMap, Callback> = {
        [eventName: string]: Callback;
      },
    >(
      object: any,
      eventHashMap: EventHashMap<Args, EventCBMap>,
      context?: any,
    ): void;
...
export namespace connectors {
  ...
  type GenericConnectorArguments<K extends ConnectorType> =
    ConnectorArgumentsMap[K];
...
export namespace anchors {
  ...
  interface MidSideAnchorArguments
    extends RotateAnchorArguments,
      PaddingAnchorArguments {
    mode?:
      | "prefer-horizontal"
      | "prefer-vertical"
      | "horizontal"
...
export namespace connectionPoints {
  ...
  interface AlignConnectionPointArguments
    extends DefaultConnectionPointArguments {
    align?: ConnectionPointAlignment | null;
    alignOffset?: number;
  }

  interface StrokeConnectionPointArguments
    extends DefaultConnectionPointArguments {
    stroke?: boolean;
  }

  interface BoundaryConnectionPointArguments
    extends StrokeConnectionPointArguments {
  ...
  type GenericConnectionPointArguments<K extends ConnectionPointType> =
    ConnectionPointArgumentsMap[K];
...
export namespace elementTools {
  ...
  abstract class Control<
    T extends mvc.ViewOptions<undefined, SVGElement> = Control.Options,
  > extends dia.ToolView<dia.ElementView> {
    options: T;
    constructor(opt?: T);
