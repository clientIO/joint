...
export namespace dia {
    ...
    interface ModelSetOptions extends mvc.Backbone.ModelSetOptions {
        dry?: boolean;
        isolate?: boolean;
        [key: string]: any;
    }

    interface CollectionAddOptions extends mvc.Backbone.AddOptions {
        dry?: boolean;
        [key: string]: any;
    }
    ...
    export namespace Graph {
        ...
        class Cells extends mvc.Backbone.Collection<Cell> {
            graph: Graph;
            cellNamespace: any;
        }
    ...
    class Graph<A extends ObjectHash = Graph.Attributes, S = dia.ModelSetOptions> extends mvc.Backbone.Model<A, S> {
    ...
    export namespace Cell {
        ...
        interface Constructor<T extends mvc.Backbone.Model> {
    ...
    class Cell<A extends ObjectHash = Cell.Attributes, S extends mvc.Backbone.ModelSetOptions = dia.ModelSetOptions> extends mvc.Backbone.Model<A, S> {
    ...
    class Element<A extends ObjectHash = Element.Attributes, S extends mvc.Backbone.ModelSetOptions = dia.ModelSetOptions> extends Cell<A, S> {
    ...
    class Link<A extends ObjectHash = Link.Attributes, S extends mvc.Backbone.ModelSetOptions = dia.ModelSetOptions> extends Cell<A, S> {
    ...
    export namespace Paper {
        ...
        */
        ...
        interface EventMap {
            ...
            // custom
            [eventName: string]: mvc.Backbone.EventHandler;
        }
    }
    ...
    class Paper extends mvc.View<Graph> {
        ...
        */
        ...
        protected onCellAdded(cell: Cell, collection: mvc.Backbone.Collection<Cell>, opt: dia.Graph.Options): void;

        protected onCellRemoved(cell: Cell, collection: mvc.Backbone.Collection<Cell>, opt: dia.Graph.Options): void;

        protected onCellChanged(cell: Cell, opt: dia.Cell.Options): void;
        protected onCellChanged(cell: mvc.Backbone.Collection<Cell>, opt: dia.Graph.Options): void;

        protected onGraphReset(cells: mvc.Backbone.Collection<Cell>, opt: dia.Graph.Options): void;
...
export namespace shapes {
    ...
    namespace standard {
        ...
        class Cylinder<S extends mvc.Backbone.ModelSetOptions = dia.ModelSetOptions> extends dia.Element<CylinderAttributes, S> {
            topRy(): string | number;
...
export namespace mvc {
    ...
    interface ViewOptions<T extends (mvc.Backbone.Model | undefined), E extends Element = HTMLElement> extends mvc.Backbone.ViewOptions<T, E> {
        theme?: string;
        [key: string]: any;
    }
    ...
    class View<T extends (mvc.Backbone.Model | undefined), E extends Element = HTMLElement> extends mvc.Backbone.View<T, E> {
        ...
        documentEvents?: mvc.Backbone.EventsHash;
        ...
        delegateDocumentEvents(events?: mvc.Backbone.EventsHash, data?: viewEventData): this;

        undelegateDocumentEvents(): this;

        delegateElementEvents(element: Element, events?: mvc.Backbone.EventsHash, data?: viewEventData): this;
