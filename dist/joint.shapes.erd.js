...
(function (exports, Backbone, _, $, V, g$1) {
    ...
    var Entity = Element.define('erd.Entity', {
    ...
    var Relationship = Element.define('erd.Relationship', {
    ...
    var Attribute = Element.define('erd.Attribute', {
    ...
    var ISA = Element.define('erd.ISA', {
        type: 'erd.ISA',
        size: { width: 100, height: 50 },
        attrs: {
            polygon: {
...
}(this.joint.shapes.erd = this.joint.shapes.erd || {}, Backbone, _, $, V, g));
