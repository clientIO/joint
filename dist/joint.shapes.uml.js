...
(function (exports, Backbone, _, $, V, g$1) {
    ...
    var State = Generic.define('uml.State', {
        attrs: {
            '.uml-state-body': {
    ...
    var StartState = Circle.define('uml.StartState', {
        type: 'uml.StartState',
        attrs: { circle: { 'fill': '#34495e', 'stroke': '#2c3e50', 'stroke-width': 2, 'rx': 1 }}
    });

    var EndState = Generic.define('uml.EndState', {
    ...
    var Transition = Link.define('uml.Transition', {
        attrs: {
...
}(this.joint.shapes.uml = this.joint.shapes.uml || {}, Backbone, _, $, V, g));
