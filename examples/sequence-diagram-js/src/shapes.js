...
export const RoleGroup = shapes.standard.Rectangle.define('sd.RoleGroup', {
    z: 1,
    attrs: {
        body: {
            stroke: '#DDDDDD',
...
export const Role = shapes.standard.Rectangle.define('sd.Role', {
    z: 2,
...
export const Lifeline = shapes.standard.Link.define('sd.Lifeline', {
    z: 3,
    attrs: {
        line: {
            stroke: '#A0A0A0',
...
export const LifeSpan = shapes.standard.Link.define('sd.LifeSpan', {
    z: 4,
    attrs: {
        line: {
            connection: true,
...
export const Message = shapes.standard.Link.define('sd.Message', {
    z: 5,
