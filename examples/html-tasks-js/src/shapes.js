...
export const HtmlElement = dia.Element.define('html.Element', {
...
export const HtmlElementView = dia.ElementView.extend({
    ...
    initFlag: dia.ElementView.prototype.initFlag.concat([
        'HTML_UPDATE',
        'HTML_FIELD_UPDATE',
        'HTML_Z_INDEX'
    ]),
    ...
    confirmUpdate: function() {
        var flags = dia.ElementView.prototype.confirmUpdate.apply(this, arguments);
    ...
    onMount(isInitialize) {
        dia.ElementView.prototype.onMount.apply(this, arguments);
        var html = this.html;
    ...
    onDetach() {
        dia.ElementView.prototype.onDetach.apply(this, arguments);
        var html = this.html;
