...
export const Bus = shapes.standard.Link.define('mix.Bus', {
    z: -1,
    attrs: {
        line: {
            strokeWidth: 5,
...
export const Connector = shapes.standard.Link.define('mix.Connector', {
    z: 0,
    attrs: {
        line: {
            sourceMarker: {
...
export const Component = shapes.standard.Rectangle.define('mix.Component', {
    z: 1,
    attrs: {
        root: {
            cursor: 'move'
...
export const Fader = dia.Element.define('mix.Fader', {
    z: 2,
    size: {
        width: 15,
        height: 80
...
export const Aux = dia.Element.define('mix.Aux', {
    z: 2,
    size: {
        width: 30,
        height: 30
