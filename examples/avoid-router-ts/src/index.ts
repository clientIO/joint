...
import { initContainersExample } from './containers/example';

type TabName = 'simple' | 'large' | 'simpleExtra' | 'containers';
...
const panels: Record<TabName, HTMLElement> = {
    ...
    containers: document.getElementById('canvas-containers') as HTMLElement,
};
...
const initializers: Record<TabName, (canvasEl: HTMLElement) => Promise<unknown>> = {
    ...
    containers: initContainersExample,
};
