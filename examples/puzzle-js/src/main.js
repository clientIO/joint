import { dia, shapes, g, V, util } from '@joint/core';
import './styles.css';

const Piece = dia.Element.define('jigsaw.Piece', {
    attrs: {
        root: {
            cursor: 'pointer'
        },
...
const Jigsaw = {
    ...
    shufflePuzzle: function(delay) {
        ...
        const pieces = this.graph.getElements();
    ...
    _setSize: function(rows, columns, pieceSize) {
        ...
        const width = this.width = columns * pieceSize;
        const height = this.height = rows * pieceSize;
