import { dia, shapes, g, V, connectionStrategies, linkTools, elementTools } from '@joint/core';
...
var roughSvg = roughjs.svg(paper.svg);
var padding = 4;
var borderEl = roughSvg.rectangle(padding, padding, WIDTH - 2 * padding, HEIGHT - 2 * padding);
paper.svg.appendChild(borderEl);
paper.rough = roughSvg;
...
var RoughElement = dia.Element.define('rough.Rectangle', {
    z: 2,
    attrs: {
        root: {
            magnet: false,
...
var RoughLink = dia.Link.define('rough.Link', {
    z: 1,
    attrs: {
        line: {
            rough: { bowing: 2 },
