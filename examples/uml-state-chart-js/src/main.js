...
const State = dia.Element.define('uml.State', {
    attrs: {
        root: {
            cursor: 'move'
        },
...
const StartState = dia.Element.define('uml.StartState', {
...
const EndState = dia.Element.define('uml.EndState', {
...
const Transition = shapes.standard.Link.define('uml.Transition', {
    attrs: {
        line: {
            targetMarker: {
                'type': 'path',
