# JointJS (for Rappid 1.x)

This branch of JointJS is used by Rappid 1.x.

[![Build Status](https://travis-ci.org/clientIO/joint.svg?branch=for-rappid-1.x)](https://travis-ci.org/clientIO/joint?branch=for-rappid-1.x)
